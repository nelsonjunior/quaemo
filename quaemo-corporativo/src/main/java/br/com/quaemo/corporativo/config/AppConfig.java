...
@ApiConfiguration(component="br.com.quaemo.corporativo", persistence="br.com.quaemo.corporativo.persistence")
public class AppConfig {

	private EntityManagerUtil em = new EntityManagerUtil("quaemo-corporativo")
			                          .dialect(EntityManagerUtil.MYSQL)
                                      .dataSource("java:jboss/datasources/Quaemo_CorporativoDS")
